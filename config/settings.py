...
# Default to DEBUG True for local testing; set DEBUG env var in production to override
DEBUG = os.environ.get('DEBUG', 'True') == 'True'
# Allow forcing DEBUG for local testing without changing production env vars
